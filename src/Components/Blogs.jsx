      ...
      <Page>
        <View>
          ...
          <Text>
            ...
            state internally. The main differences between them is direct DOM
            manipulations. Since uncontrolled components manage their own state,
            they directly manipulate the DOM to update their values, without
            involving the application's state management. Controlled components
            can not do it. Also, as the name suggests, uncontrolled components
            provide less control to the developer. On the other hand, controlled
            components offer more control to the developer. They allow for
            validation and modification of the input before updating the
            application's state. So, this is the differences between
            uncontrolled and controlled components.
          </Text>
        </View>
        <View>
          <Text>Question 2: How to validate React props using PropTypes</Text>
          <Text>
            Ans: To validate React props using PropTypes, we first need to
            install PropTypes using "npm install prop-types" command and then
            import PropTypes like import PropTypes from 'prop-types'. After that
            need to define PropTypes. Finally, use the Component with Validated
            Props. That's how we validate React props using PropTypes.
          </Text>
        </View>
        <View>
          <Text>
          ...
          <Text>
            Ans: Node.js and Express.js are both popular technologies used in
            web development. Node.js is a server-side JavaScript runtime
            environment, while Express.js is a web application framework built
            on top of Node.js. The main difference between them is, Node.js is a
            server-side JavaScript runtime environment that allows developers to
            build server-side applications in JavaScript. It provides an
            event-driven, non-blocking I/O model that makes it efficient and
            scalable. While, Express.js is a web application framework built on
            top of Node.js. It provides a set of tools and libraries for
      ...
      <Page>
        <View>
          ...
          <Text>
            ...
            'use' and that may call other Hooks. Custom Hooks offer the
            flexibility of sharing logic that wasn't possible in React
            components before. That's why most people nowadays use custom hook.
            It also enhances the rendering speed of the code as a custom hook
            does not need to be rendered again and again while rendering the
            whole code. This is the reason, I will create a custom hook.
          </Text>
        </View>
      </Page>
    </Document>
